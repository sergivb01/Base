package idaniel84.base.kit;

import com.google.common.base.Preconditions;
import idaniel84.base.BasePlugin;
import idaniel84.base.kit.event.KitApplyEvent;
import idaniel84.util.GenericUtils;
import idaniel84.util.InventoryUtils;
...
public class Kit
	...
	public boolean applyTo(Player player, boolean force, boolean inform){
		...
		if(BasePlugin.getPlugin().getConfig().getBoolean("kit-map")){
